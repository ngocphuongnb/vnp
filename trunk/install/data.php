...
$sql_create_table[] = "CREATE TABLE `" . CONTENT_FIELD . "` (
  ...
  `ref_ct_type` mediumint(8) unsigned NOT NULL default '0',
  `ref_field` mediumint(8) unsigned NOT NULL default '0',
  `require` tinyint(1) unsigned DEFAULT '0',
  `option_nums` int(8) NOT NULL DEFAULT '0',
  `option_data` mediumtext,
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0',
